        ...
        <div id="content">
            ...
            <center>
                ...
                <div id="box<?php echo $no; ?>" class="open">
                    ...
                    <center>
                        <?php
                            $qu = "select q.question,q.id, q.answer, q.askedby, q.answeredby from quans as q, quacat as r, category as c where q.id=r.id and r.category=c.name and c.id='$no' Limit 8";
